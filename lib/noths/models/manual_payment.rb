...
module Noths
  ...
  class ManualPayment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'payment_reason')
        self.payment_reason = attributes[:'payment_reason']
      end
    ...
    def list_invalid_properties
      ...
      if @payment_reason.nil?
        invalid_properties.push("invalid value for 'payment_reason', payment_reason cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @payment_reason.nil?
    ...
    def hash
      [id, payment_reason, commission, amount].hash
    end
