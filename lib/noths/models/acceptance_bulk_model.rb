...
module Noths
  ...
  class AcceptanceBulkModel
    ...
    attr_accessor :confirmation_note
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'confirmation_note')
        self.confirmation_note = attributes[:'confirmation_note']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          confirmation_note == o.confirmation_note
    end
    ...
    def hash
      [id, estimated_delivery_date, estimated_dispatch_at, confirmation_note].hash
    end
